...
[tsvergeos](../README.md) / services/ipsec

# services/ipsec

IPSec service registration module.

Importing this module registers the [IPSecService](#ipsecservice) on [VergeClient](../index.md#vergeclient),
...
Defined in: [services/ipsec/service.ts:27](https://github.com/verge-io/tsvergeos/blob/c133d655c3866a221a89ec91a350542833cb46f6/packages/sdk/src/services/ipsec/service.ts#L27)
...
one IPSec config. Use [getByNetwork](#getbynetwork) to retrieve the config for a
...
IPSecPhase1Service and IPSecPhase2Service respectively.
...
- [`BaseService`](../index.md#baseservice)\<[`IPSec`](../types.md#ipsec), [`IPSecCreateParams`](../types.md#ipseccreateparams), [`IPSecUpdateParams`](../types.md#ipsecupdateparams)\>

#### Constructors

##### Constructor

> **new IPSecService**(`http`): [`IPSecService`](#ipsecservice)

Defined in: [services/ipsec/service.ts:28](https://github.com/verge-io/tsvergeos/blob/c133d655c3866a221a89ec91a350542833cb46f6/packages/sdk/src/services/ipsec/service.ts#L28)
...
> **list**(`options?`): `Promise`\<[`IPSec`](../types.md#ipsec)[]\>
...
> **get**(`key`): `Promise`\<[`IPSec`](../types.md#ipsec)\>
...
> **getByName**(`name`): `Promise`\<[`IPSec`](../types.md#ipsec)\>
...
> **listAll**(`options?`): `AsyncGenerator`\<[`IPSec`](../types.md#ipsec)\>
...
`AsyncGenerator`\<[`IPSec`](../types.md#ipsec)\>
...
> **update**(`key`, `params`, `options?`): `Promise`\<[`IPSec`](../types.md#ipsec)\>
...
| `params` | [`IPSecUpdateParams`](../types.md#ipsecupdateparams) | The fields to update |
...
> **create**(`params`, `options?`): `Promise`\<[`IPSec`](../types.md#ipsec)\>
...
| Parameter | Type | Description |
| ------ | ------ | ------ |
| `params` | [`IPSecCreateParams`](../types.md#ipseccreateparams) | The resource creation parameters |
| `options?` | [`MutationOptions`](../types.md#mutationoptions) | Mutation options (e.g., `readBack: false` to skip re-fetch) |
...
> **getByNetwork**(`vnetKey`): `Promise`\<[`IPSec`](../types.md#ipsec)\>

Defined in: [services/ipsec/service.ts:42](https://github.com/verge-io/tsvergeos/blob/c133d655c3866a221a89ec91a350542833cb46f6/packages/sdk/src/services/ipsec/service.ts#L42)
...
The IPSec configuration for the specified network

###### Throws

NotFoundError if no IPSec config exists for the network

##### listByNetwork()

> **listByNetwork**(`vnetKey`, `options?`): `Promise`\<[`IPSec`](../types.md#ipsec)[]\>

Defined in: [services/ipsec/service.ts:64](https://github.com/verge-io/tsvergeos/blob/c133d655c3866a221a89ec91a350542833cb46f6/packages/sdk/src/services/ipsec/service.ts#L64)
...
Array of IPSec configurations for the specified network

## References

### IPSec

Re-exports [IPSec](../types.md#ipsec)

***

### IPSecCreateParams

Re-exports [IPSecCreateParams](../types.md#ipseccreateparams)

***

### IPSecMode

Re-exports [IPSecMode](../types.md#ipsecmode)

***

### IPSecStrictCrlPolicy

Re-exports [IPSecStrictCrlPolicy](../types.md#ipsecstrictcrlpolicy)

***

### IPSecUniqueIds

Re-exports [IPSecUniqueIds](../types.md#ipsecuniqueids)

***

### IPSecUpdateParams

Re-exports [IPSecUpdateParams](../types.md#ipsecupdateparams)
