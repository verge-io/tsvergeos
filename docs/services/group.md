...
[tsvergeos](../README.md) / services/group

# services/group

Group service registration module.

Importing this module registers the [GroupService](#groupservice) on [VergeClient](../index.md#vergeclient),
...
Defined in: [services/group/service.ts:26](https://github.com/verge-io/tsvergeos/blob/c133d655c3866a221a89ec91a350542833cb46f6/packages/sdk/src/services/group/service.ts#L26)
...
- [`BaseService`](../index.md#baseservice)\<[`Group`](../types.md#group), [`GroupCreateParams`](../types.md#groupcreateparams), [`GroupUpdateParams`](../types.md#groupupdateparams)\>

#### Constructors

##### Constructor

> **new GroupService**(`http`): [`GroupService`](#groupservice)

Defined in: [services/group/service.ts:27](https://github.com/verge-io/tsvergeos/blob/c133d655c3866a221a89ec91a350542833cb46f6/packages/sdk/src/services/group/service.ts#L27)
...
> **list**(`options?`): `Promise`\<[`Group`](../types.md#group)[]\>
...
> **get**(`key`): `Promise`\<[`Group`](../types.md#group)\>
...
> **getByName**(`name`): `Promise`\<[`Group`](../types.md#group)\>
...
> **listAll**(`options?`): `AsyncGenerator`\<[`Group`](../types.md#group)\>
...
`AsyncGenerator`\<[`Group`](../types.md#group)\>
...
> **update**(`key`, `params`, `options?`): `Promise`\<[`Group`](../types.md#group)\>
...
| `params` | [`GroupUpdateParams`](../types.md#groupupdateparams) | The fields to update |
...
> **create**(`params`, `options?`): `Promise`\<[`Group`](../types.md#group)\>
...
| Parameter | Type | Description |
| ------ | ------ | ------ |
| `params` | [`GroupCreateParams`](../types.md#groupcreateparams) | The resource creation parameters |
| `options?` | [`MutationOptions`](../types.md#mutationoptions) | Mutation options (e.g., `readBack: false` to skip re-fetch) |
...
Defined in: [services/group/service.ts:39](https://github.com/verge-io/tsvergeos/blob/c133d655c3866a221a89ec91a350542833cb46f6/packages/sdk/src/services/group/service.ts#L39)
...
| Parameter | Type | Description |
| ------ | ------ | ------ |
| `key` | [`FlexKey`](../types.md#flexkey) | The group ID |
...
Defined in: [services/group/service.ts:51](https://github.com/verge-io/tsvergeos/blob/c133d655c3866a221a89ec91a350542833cb46f6/packages/sdk/src/services/group/service.ts#L51)
...
Re-exports [Group](../types.md#group)

***

### GroupCreateParams

Re-exports [GroupCreateParams](../types.md#groupcreateparams)

***

### GroupUpdateParams

Re-exports [GroupUpdateParams](../types.md#groupupdateparams)
