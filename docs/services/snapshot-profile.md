...
[tsvergeos](../README.md) / services/snapshot-profile

# services/snapshot-profile

Snapshot profile service registration module.

Importing this module registers the [SnapshotProfileService](#snapshotprofileservice) on [VergeClient](../index.md#vergeclient),
...
### SnapshotProfileService

Defined in: [services/snapshot-profile/service.ts:37](https://github.com/verge-io/tsvergeos/blob/062717088bda09370ccf0807d21fafeb6b471b69/packages/sdk/src/services/snapshot-profile/service.ts#L37)
...
Use SnapshotProfilePeriodService to manage the individual schedule
...
- [`BaseService`](../index.md#baseservice)\<[`SnapshotProfile`](../types.md#snapshotprofile), [`SnapshotProfileCreateParams`](../types.md#snapshotprofilecreateparams), [`SnapshotProfileUpdateParams`](../types.md#snapshotprofileupdateparams)\>

#### Constructors

##### Constructor

> **new SnapshotProfileService**(`http`): [`SnapshotProfileService`](#snapshotprofileservice)

Defined in: [services/snapshot-profile/service.ts:42](https://github.com/verge-io/tsvergeos/blob/062717088bda09370ccf0807d21fafeb6b471b69/packages/sdk/src/services/snapshot-profile/service.ts#L42)
...
[`SnapshotProfileService`](#snapshotprofileservice)
...
> **list**(`options?`): `Promise`\<[`SnapshotProfile`](../types.md#snapshotprofile)[]\>
...
`Promise`\<[`SnapshotProfile`](../types.md#snapshotprofile)[]\>
...
> **get**(`key`): `Promise`\<[`SnapshotProfile`](../types.md#snapshotprofile)\>
...
> **getByName**(`name`): `Promise`\<[`SnapshotProfile`](../types.md#snapshotprofile)\>
...
> **listAll**(`options?`): `AsyncGenerator`\<[`SnapshotProfile`](../types.md#snapshotprofile)\>
...
`AsyncGenerator`\<[`SnapshotProfile`](../types.md#snapshotprofile)\>
...
> **update**(`key`, `params`, `options?`): `Promise`\<[`SnapshotProfile`](../types.md#snapshotprofile)\>
...
| `params` | [`SnapshotProfileUpdateParams`](../types.md#snapshotprofileupdateparams) | The fields to update |
...
> **create**(`params`, `options?`): `Promise`\<[`SnapshotProfile`](../types.md#snapshotprofile)\>
...
| Parameter | Type | Description |
| ------ | ------ | ------ |
| `params` | [`SnapshotProfileCreateParams`](../types.md#snapshotprofilecreateparams) | The resource creation parameters |
| `options?` | [`MutationOptions`](../types.md#mutationoptions) | Mutation options (e.g., `readBack: false` to skip re-fetch) |
...
Defined in: [services/snapshot-profile/service.ts:54](https://github.com/verge-io/tsvergeos/blob/062717088bda09370ccf0807d21fafeb6b471b69/packages/sdk/src/services/snapshot-profile/service.ts#L54)
...
| Parameter | Type | Description |
| ------ | ------ | ------ |
| `key` | [`FlexKey`](../types.md#flexkey) | The snapshot profile ID to delete |
...
Re-exports [SnapshotProfile](../types.md#snapshotprofile)

***

### SnapshotProfileCreateParams

Re-exports [SnapshotProfileCreateParams](../types.md#snapshotprofilecreateparams)

***

### SnapshotProfileUpdateParams

Re-exports [SnapshotProfileUpdateParams](../types.md#snapshotprofileupdateparams)
