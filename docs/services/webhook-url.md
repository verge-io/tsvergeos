...
[tsvergeos](../README.md) / services/webhook-url

# services/webhook-url

Webhook URL service registration module.

Importing this module registers the [WebhookURLService](#webhookurlservice) on [VergeClient](../index.md#vergeclient),
...
Defined in: [services/webhook-url/service.ts:32](https://github.com/verge-io/tsvergeos/blob/c133d655c3866a221a89ec91a350542833cb46f6/packages/sdk/src/services/webhook-url/service.ts#L32)
...
- [`BaseService`](../index.md#baseservice)\<[`WebhookURL`](../types.md#webhookurl), [`WebhookURLCreateParams`](../types.md#webhookurlcreateparams), [`WebhookURLUpdateParams`](../types.md#webhookurlupdateparams)\>

#### Constructors

##### Constructor

> **new WebhookURLService**(`http`): [`WebhookURLService`](#webhookurlservice)

Defined in: [services/webhook-url/service.ts:37](https://github.com/verge-io/tsvergeos/blob/c133d655c3866a221a89ec91a350542833cb46f6/packages/sdk/src/services/webhook-url/service.ts#L37)
...
> **list**(`options?`): `Promise`\<[`WebhookURL`](../types.md#webhookurl)[]\>
...
`Promise`\<[`WebhookURL`](../types.md#webhookurl)[]\>
...
> **get**(`key`): `Promise`\<[`WebhookURL`](../types.md#webhookurl)\>
...
> **getByName**(`name`): `Promise`\<[`WebhookURL`](../types.md#webhookurl)\>
...
> **listAll**(`options?`): `AsyncGenerator`\<[`WebhookURL`](../types.md#webhookurl)\>
...
`AsyncGenerator`\<[`WebhookURL`](../types.md#webhookurl)\>
...
> **update**(`key`, `params`, `options?`): `Promise`\<[`WebhookURL`](../types.md#webhookurl)\>
...
| `params` | [`WebhookURLUpdateParams`](../types.md#webhookurlupdateparams) | The fields to update |
...
> **create**(`params`, `options?`): `Promise`\<[`WebhookURL`](../types.md#webhookurl)\>
...
| Parameter | Type | Description |
| ------ | ------ | ------ |
| `params` | [`WebhookURLCreateParams`](../types.md#webhookurlcreateparams) | The resource creation parameters |
| `options?` | [`MutationOptions`](../types.md#mutationoptions) | Mutation options (e.g., `readBack: false` to skip re-fetch) |
...
> **send**(`key`, `message`): `Promise`\<`void`\>

Defined in: [services/webhook-url/service.ts:49](https://github.com/verge-io/tsvergeos/blob/c133d655c3866a221a89ec91a350542833cb46f6/packages/sdk/src/services/webhook-url/service.ts#L49)
...
| Parameter | Type | Description |
| ------ | ------ | ------ |
| `key` | [`FlexKey`](../types.md#flexkey) | The webhook URL ID |
...
Re-exports [WebhookURL](../types.md#webhookurl)

***

### WebhookURLAuthorizationType

Re-exports [WebhookURLAuthorizationType](../types.md#webhookurlauthorizationtype)

***

### WebhookURLCreateParams

Re-exports [WebhookURLCreateParams](../types.md#webhookurlcreateparams)

***

### WebhookURLType

Re-exports [WebhookURLType](../types.md#webhookurltype)

***

### WebhookURLUpdateParams

Re-exports [WebhookURLUpdateParams](../types.md#webhookurlupdateparams)
