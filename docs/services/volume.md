...
Defined in: services/volume/service.ts:36
...
Defined in: services/volume/service.ts:37
...
Defined in: services/volume/service.ts:46
...
Defined in: services/volume/service.ts:55
...
Defined in: services/volume/service.ts:64
...
Defined in: services/volume/service.ts:77
...
Defined in: services/volume/service.ts:93
...
Defined in: services/volume/service.ts:102
...
Defined in: services/volume/types.ts:246
...
| ------ | ------ | ------ | ------ |
| <a id="property-restoretype"></a> `restoreType?` | [`VolumeRestoreType`](#volumerestoretype) | What to restore. `'data'` restores data only, `'all'` restores data and settings. Default: `'data'`. | services/volume/types.ts:248 |
...
Defined in: services/volume/types.ts:243
