...
[tsvergeos](../README.md) / services/volume-snapshot

# services/volume-snapshot

Volume Snapshot service registration module.

Importing this module registers the [VolumeSnapshotService](#volumesnapshotservice) on [VergeClient](../index.md#vergeclient),
...
Defined in: [services/volume-snapshot/service.ts:32](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/services/volume-snapshot/service.ts#L32)
...
standard integer keys. Use [listByVolume](#listbyvolume) to list snapshots
...
- [`BaseService`](../index.md#baseservice)\<[`VolumeSnapshot`](../types.md#volumesnapshot), [`VolumeSnapshotCreateParams`](../types.md#volumesnapshotcreateparams), [`VolumeSnapshotUpdateParams`](../types.md#volumesnapshotupdateparams)\>

#### Constructors

##### Constructor

> **new VolumeSnapshotService**(`http`): [`VolumeSnapshotService`](#volumesnapshotservice)

Defined in: [services/volume-snapshot/service.ts:37](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/services/volume-snapshot/service.ts#L37)
...
> **list**(`options?`): `Promise`\<[`VolumeSnapshot`](../types.md#volumesnapshot)[]\>
...
`Promise`\<[`VolumeSnapshot`](../types.md#volumesnapshot)[]\>
...
> **get**(`key`): `Promise`\<[`VolumeSnapshot`](../types.md#volumesnapshot)\>
...
> **getByName**(`name`): `Promise`\<[`VolumeSnapshot`](../types.md#volumesnapshot)\>
...
> **listAll**(`options?`): `AsyncGenerator`\<[`VolumeSnapshot`](../types.md#volumesnapshot)\>
...
`AsyncGenerator`\<[`VolumeSnapshot`](../types.md#volumesnapshot)\>
...
> **update**(`key`, `params`, `options?`): `Promise`\<[`VolumeSnapshot`](../types.md#volumesnapshot)\>
...
| `params` | [`VolumeSnapshotUpdateParams`](../types.md#volumesnapshotupdateparams) | The fields to update |
...
> **create**(`params`, `options?`): `Promise`\<[`VolumeSnapshot`](../types.md#volumesnapshot)\>
...
| Parameter | Type | Description |
| ------ | ------ | ------ |
| `params` | [`VolumeSnapshotCreateParams`](../types.md#volumesnapshotcreateparams) | The resource creation parameters |
| `options?` | [`MutationOptions`](../types.md#mutationoptions) | Mutation options (e.g., `readBack: false` to skip re-fetch) |
...
> **listByVolume**(`volumeKey`, `options?`): `Promise`\<[`VolumeSnapshot`](../types.md#volumesnapshot)[]\>

Defined in: [services/volume-snapshot/service.ts:52](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/services/volume-snapshot/service.ts#L52)
...
Array of snapshots for the specified volume

## References

### VolumeSnapshot

Re-exports [VolumeSnapshot](../types.md#volumesnapshot)

***

### VolumeSnapshotCreateParams

Re-exports [VolumeSnapshotCreateParams](../types.md#volumesnapshotcreateparams)

***

### VolumeSnapshotExpiresType

Re-exports [VolumeSnapshotExpiresType](../types.md#volumesnapshotexpirestype)

***

### VolumeSnapshotUpdateParams

Re-exports [VolumeSnapshotUpdateParams](../types.md#volumesnapshotupdateparams)
