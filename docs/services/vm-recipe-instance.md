...
[tsvergeos](../README.md) / services/vm-recipe-instance

# services/vm-recipe-instance

VM recipe instance service registration module.

Importing this module registers the [VMRecipeInstanceService](#vmrecipeinstanceservice) on [VergeClient](../index.md#vergeclient),
...
### VMRecipeInstanceService

Defined in: [services/vm-recipe-instance/service.ts:38](https://github.com/verge-io/tsvergeos/blob/062717088bda09370ccf0807d21fafeb6b471b69/packages/sdk/src/services/vm-recipe-instance/service.ts#L38)
...
- [`BaseService`](../index.md#baseservice)\<[`VMRecipeInstance`](../types.md#vmrecipeinstance), [`VMRecipeInstanceCreateParams`](../types.md#vmrecipeinstancecreateparams), [`VMRecipeInstanceUpdateParams`](../types.md#vmrecipeinstanceupdateparams)\>

#### Constructors

##### Constructor

> **new VMRecipeInstanceService**(`http`): [`VMRecipeInstanceService`](#vmrecipeinstanceservice)

Defined in: [services/vm-recipe-instance/service.ts:43](https://github.com/verge-io/tsvergeos/blob/062717088bda09370ccf0807d21fafeb6b471b69/packages/sdk/src/services/vm-recipe-instance/service.ts#L43)
...
[`VMRecipeInstanceService`](#vmrecipeinstanceservice)
...
> **list**(`options?`): `Promise`\<[`VMRecipeInstance`](../types.md#vmrecipeinstance)[]\>
...
`Promise`\<[`VMRecipeInstance`](../types.md#vmrecipeinstance)[]\>
...
> **get**(`key`): `Promise`\<[`VMRecipeInstance`](../types.md#vmrecipeinstance)\>
...
> **getByName**(`name`): `Promise`\<[`VMRecipeInstance`](../types.md#vmrecipeinstance)\>
...
> **listAll**(`options?`): `AsyncGenerator`\<[`VMRecipeInstance`](../types.md#vmrecipeinstance)\>
...
`AsyncGenerator`\<[`VMRecipeInstance`](../types.md#vmrecipeinstance)\>
...
> **update**(`key`, `params`, `options?`): `Promise`\<[`VMRecipeInstance`](../types.md#vmrecipeinstance)\>
...
| `params` | [`VMRecipeInstanceUpdateParams`](../types.md#vmrecipeinstanceupdateparams) | The fields to update |
...
> **create**(`params`, `options?`): `Promise`\<[`VMRecipeInstance`](../types.md#vmrecipeinstance)\>
...
| Parameter | Type | Description |
| ------ | ------ | ------ |
| `params` | [`VMRecipeInstanceCreateParams`](../types.md#vmrecipeinstancecreateparams) | The resource creation parameters |
| `options?` | [`MutationOptions`](../types.md#mutationoptions) | Mutation options (e.g., `readBack: false` to skip re-fetch) |
...
Re-exports [VMRecipeInstance](../types.md#vmrecipeinstance)

***

### VMRecipeInstanceCreateParams

Re-exports [VMRecipeInstanceCreateParams](../types.md#vmrecipeinstancecreateparams)

***

### VMRecipeInstanceUpdateParams

Re-exports [VMRecipeInstanceUpdateParams](../types.md#vmrecipeinstanceupdateparams)
