...
[tsvergeos](../README.md) / services/network-rule-alias

# services/network-rule-alias

Network Rule Alias service registration module.

Importing this module registers the [NetworkRuleAliasService](#networkrulealiasservice) on [VergeClient](../index.md#vergeclient),
...
### NetworkRuleAliasService

Defined in: [services/network-rule-alias/service.ts:43](https://github.com/verge-io/tsvergeos/blob/062717088bda09370ccf0807d21fafeb6b471b69/packages/sdk/src/services/network-rule-alias/service.ts#L43)
...
- [`BaseService`](../index.md#baseservice)\<[`NetworkRuleAlias`](../types.md#networkrulealias), [`NetworkRuleAliasCreateParams`](../types.md#networkrulealiascreateparams), [`NetworkRuleAliasUpdateParams`](../types.md#networkrulealiasupdateparams)\>

#### Constructors

##### Constructor

> **new NetworkRuleAliasService**(`http`): [`NetworkRuleAliasService`](#networkrulealiasservice)

Defined in: [services/network-rule-alias/service.ts:48](https://github.com/verge-io/tsvergeos/blob/062717088bda09370ccf0807d21fafeb6b471b69/packages/sdk/src/services/network-rule-alias/service.ts#L48)
...
[`NetworkRuleAliasService`](#networkrulealiasservice)
...
> **list**(`options?`): `Promise`\<[`NetworkRuleAlias`](../types.md#networkrulealias)[]\>
...
`Promise`\<[`NetworkRuleAlias`](../types.md#networkrulealias)[]\>
...
> **get**(`key`): `Promise`\<[`NetworkRuleAlias`](../types.md#networkrulealias)\>
...
> **getByName**(`name`): `Promise`\<[`NetworkRuleAlias`](../types.md#networkrulealias)\>
...
> **listAll**(`options?`): `AsyncGenerator`\<[`NetworkRuleAlias`](../types.md#networkrulealias)\>
...
`AsyncGenerator`\<[`NetworkRuleAlias`](../types.md#networkrulealias)\>
...
> **update**(`key`, `params`, `options?`): `Promise`\<[`NetworkRuleAlias`](../types.md#networkrulealias)\>
...
| `params` | [`NetworkRuleAliasUpdateParams`](../types.md#networkrulealiasupdateparams) | The fields to update |
...
> **create**(`params`, `options?`): `Promise`\<[`NetworkRuleAlias`](../types.md#networkrulealias)\>
...
| Parameter | Type | Description |
| ------ | ------ | ------ |
| `params` | [`NetworkRuleAliasCreateParams`](../types.md#networkrulealiascreateparams) | The resource creation parameters |
| `options?` | [`MutationOptions`](../types.md#mutationoptions) | Mutation options (e.g., `readBack: false` to skip re-fetch) |
...
Re-exports [NetworkRuleAlias](../types.md#networkrulealias)

***

### NetworkRuleAliasCreateParams

Re-exports [NetworkRuleAliasCreateParams](../types.md#networkrulealiascreateparams)

***

### NetworkRuleAliasUpdateParams

Re-exports [NetworkRuleAliasUpdateParams](../types.md#networkrulealiasupdateparams)

***

### PublishingScope

Re-exports [PublishingScope](../types.md#publishingscope)
