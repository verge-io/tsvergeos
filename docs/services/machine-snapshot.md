...
[tsvergeos](../README.md) / services/machine-snapshot

# services/machine-snapshot

Machine Snapshot service registration module.

Importing this module registers the [MachineSnapshotService](#machinesnapshotservice) on [VergeClient](../index.md#vergeclient),
...
Defined in: [services/machine-snapshot/service.ts:31](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/services/machine-snapshot/service.ts#L31)

Service for managing VergeOS machine snapshots.

Machine snapshots capture the state of a machine (VM or physical node)
at a point in time. Use [listByMachine](#listbymachine) to list snapshots for a
specific machine.
...
- [`BaseService`](../index.md#baseservice)\<[`MachineSnapshot`](../types.md#machinesnapshot), [`MachineSnapshotCreateParams`](../types.md#machinesnapshotcreateparams), [`MachineSnapshotUpdateParams`](../types.md#machinesnapshotupdateparams)\>

#### Constructors

##### Constructor

> **new MachineSnapshotService**(`http`): [`MachineSnapshotService`](#machinesnapshotservice)

Defined in: [services/machine-snapshot/service.ts:36](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/services/machine-snapshot/service.ts#L36)
...
[`MachineSnapshotService`](#machinesnapshotservice)
...
> **list**(`options?`): `Promise`\<[`MachineSnapshot`](../types.md#machinesnapshot)[]\>
...
`Promise`\<[`MachineSnapshot`](../types.md#machinesnapshot)[]\>
...
> **get**(`key`): `Promise`\<[`MachineSnapshot`](../types.md#machinesnapshot)\>
...
> **getByName**(`name`): `Promise`\<[`MachineSnapshot`](../types.md#machinesnapshot)\>
...
> **listAll**(`options?`): `AsyncGenerator`\<[`MachineSnapshot`](../types.md#machinesnapshot)\>
...
`AsyncGenerator`\<[`MachineSnapshot`](../types.md#machinesnapshot)\>
...
> **update**(`key`, `params`, `options?`): `Promise`\<[`MachineSnapshot`](../types.md#machinesnapshot)\>
...
| `params` | [`MachineSnapshotUpdateParams`](../types.md#machinesnapshotupdateparams) | The fields to update |
...
> **create**(`params`, `options?`): `Promise`\<[`MachineSnapshot`](../types.md#machinesnapshot)\>
...
| Parameter | Type | Description |
| ------ | ------ | ------ |
| `params` | [`MachineSnapshotCreateParams`](../types.md#machinesnapshotcreateparams) | The resource creation parameters |
| `options?` | [`MutationOptions`](../types.md#mutationoptions) | Mutation options (e.g., `readBack: false` to skip re-fetch) |
...
> **listByMachine**(`machineKey`, `options?`): `Promise`\<[`MachineSnapshot`](../types.md#machinesnapshot)[]\>

Defined in: [services/machine-snapshot/service.ts:49](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/services/machine-snapshot/service.ts#L49)
...
Array of snapshots for the specified machine

##### expiresTimer()

> **expiresTimer**(`key`, `expires`): `Promise`\<`void`\>

Defined in: [services/machine-snapshot/service.ts:70](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/services/machine-snapshot/service.ts#L70)
...
| `expires` | `number` | Expiration timestamp (Unix epoch seconds). Set to `0` to never expire. |
...
Re-exports [ExpiresType](../types.md#expirestype)

***

### MachineSnapshot

Re-exports [MachineSnapshot](../types.md#machinesnapshot)

***

### MachineSnapshotCreateParams

Re-exports [MachineSnapshotCreateParams](../types.md#machinesnapshotcreateparams)

***

### MachineSnapshotUpdateParams

Re-exports [MachineSnapshotUpdateParams](../types.md#machinesnapshotupdateparams)
