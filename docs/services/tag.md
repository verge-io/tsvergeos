...
[tsvergeos](../README.md) / services/tag

# services/tag

Tag service registration module.

Importing this module registers the [TagService](#tagservice) on [VergeClient](../index.md#vergeclient),
...
Defined in: [services/tag/service.ts:34](https://github.com/verge-io/tsvergeos/blob/062717088bda09370ccf0807d21fafeb6b471b69/packages/sdk/src/services/tag/service.ts#L34)

Service for managing VergeOS tags.

Tags are named labels belonging to a TagCategory. They can be applied
...
- [`BaseService`](../index.md#baseservice)\<[`Tag`](../types.md#tag), [`TagCreateParams`](../types.md#tagcreateparams), [`TagUpdateParams`](../types.md#tagupdateparams)\>

#### Constructors

##### Constructor

> **new TagService**(`http`): [`TagService`](#tagservice)

Defined in: [services/tag/service.ts:35](https://github.com/verge-io/tsvergeos/blob/062717088bda09370ccf0807d21fafeb6b471b69/packages/sdk/src/services/tag/service.ts#L35)
...
> **list**(`options?`): `Promise`\<[`Tag`](../types.md#tag)[]\>
...
> **get**(`key`): `Promise`\<[`Tag`](../types.md#tag)\>
...
> **getByName**(`name`): `Promise`\<[`Tag`](../types.md#tag)\>
...
> **listAll**(`options?`): `AsyncGenerator`\<[`Tag`](../types.md#tag)\>
...
`AsyncGenerator`\<[`Tag`](../types.md#tag)\>
...
> **update**(`key`, `params`, `options?`): `Promise`\<[`Tag`](../types.md#tag)\>
...
| `params` | [`TagUpdateParams`](../types.md#tagupdateparams) | The fields to update |
...
> **create**(`params`, `options?`): `Promise`\<[`Tag`](../types.md#tag)\>
...
| Parameter | Type | Description |
| ------ | ------ | ------ |
| `params` | [`TagCreateParams`](../types.md#tagcreateparams) | The resource creation parameters |
| `options?` | [`MutationOptions`](../types.md#mutationoptions) | Mutation options (e.g., `readBack: false` to skip re-fetch) |
...
> **listByCategory**(`categoryKey`, `options?`): `Promise`\<[`Tag`](../types.md#tag)[]\>

Defined in: [services/tag/service.ts:48](https://github.com/verge-io/tsvergeos/blob/062717088bda09370ccf0807d21fafeb6b471b69/packages/sdk/src/services/tag/service.ts#L48)
...
| Parameter | Type | Description |
| ------ | ------ | ------ |
| `categoryKey` | [`FlexKey`](../types.md#flexkey) | The parent tag category ID |
...
Array of tags in the specified category

## References

### Tag

Re-exports [Tag](../types.md#tag)

***

### TagCreateParams

Re-exports [TagCreateParams](../types.md#tagcreateparams)

***

### TagUpdateParams

Re-exports [TagUpdateParams](../types.md#tagupdateparams)
