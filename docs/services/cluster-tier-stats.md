...
[tsvergeos](../README.md) / services/cluster-tier-stats

# services/cluster-tier-stats

Cluster Tier Stats service registration module.

Importing this module registers the [ClusterTierStatsService](#clustertierstatsservice) on [VergeClient](../index.md#vergeclient),
...
### ClusterTierStatsService

Defined in: [services/cluster-tier-stats/service.ts:23](https://github.com/verge-io/tsvergeos/blob/c133d655c3866a221a89ec91a350542833cb46f6/packages/sdk/src/services/cluster-tier-stats/service.ts#L23)
...
- [`ReadOnlyService`](../index.md#readonlyservice)\<[`ClusterTierStats`](../types.md#clustertierstats)\>

#### Constructors

##### Constructor

> **new ClusterTierStatsService**(`http`): [`ClusterTierStatsService`](#clustertierstatsservice)

Defined in: [services/cluster-tier-stats/service.ts:24](https://github.com/verge-io/tsvergeos/blob/c133d655c3866a221a89ec91a350542833cb46f6/packages/sdk/src/services/cluster-tier-stats/service.ts#L24)
...
[`ClusterTierStatsService`](#clustertierstatsservice)
...
> **list**(`options?`): `Promise`\<[`ClusterTierStats`](../types.md#clustertierstats)[]\>
...
`Promise`\<[`ClusterTierStats`](../types.md#clustertierstats)[]\>
...
> **get**(`key`): `Promise`\<[`ClusterTierStats`](../types.md#clustertierstats)\>
...
> **getByName**(`name`): `Promise`\<[`ClusterTierStats`](../types.md#clustertierstats)\>
...
> **listAll**(`options?`): `AsyncGenerator`\<[`ClusterTierStats`](../types.md#clustertierstats)\>
...
`AsyncGenerator`\<[`ClusterTierStats`](../types.md#clustertierstats)\>
...
> **listByClusterTier**(`clusterTierKey`): `Promise`\<[`ClusterTierStats`](../types.md#clustertierstats)[]\>

Defined in: [services/cluster-tier-stats/service.ts:34](https://github.com/verge-io/tsvergeos/blob/c133d655c3866a221a89ec91a350542833cb46f6/packages/sdk/src/services/cluster-tier-stats/service.ts#L34)
...
Array of cluster tier stats for the given cluster tier.

## References

### ClusterTierStats

Re-exports [ClusterTierStats](../types.md#clustertierstats)
