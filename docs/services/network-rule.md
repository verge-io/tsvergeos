...
[tsvergeos](../README.md) / services/network-rule

# services/network-rule

Network Rule service registration module.

Importing this module registers the [NetworkRuleService](#networkruleservice) on [VergeClient](../index.md#vergeclient),
...
Defined in: [services/network-rule/service.ts:38](https://github.com/verge-io/tsvergeos/blob/062717088bda09370ccf0807d21fafeb6b471b69/packages/sdk/src/services/network-rule/service.ts#L38)
...
- [`BaseService`](../index.md#baseservice)\<[`NetworkRule`](../types.md#networkrule), [`NetworkRuleCreateParams`](../types.md#networkrulecreateparams), [`NetworkRuleUpdateParams`](../types.md#networkruleupdateparams)\>

#### Constructors

##### Constructor

> **new NetworkRuleService**(`http`): [`NetworkRuleService`](#networkruleservice)

Defined in: [services/network-rule/service.ts:43](https://github.com/verge-io/tsvergeos/blob/062717088bda09370ccf0807d21fafeb6b471b69/packages/sdk/src/services/network-rule/service.ts#L43)
...
[`NetworkRuleService`](#networkruleservice)
...
> **list**(`options?`): `Promise`\<[`NetworkRule`](../types.md#networkrule)[]\>
...
`Promise`\<[`NetworkRule`](../types.md#networkrule)[]\>
...
> **get**(`key`): `Promise`\<[`NetworkRule`](../types.md#networkrule)\>
...
> **getByName**(`name`): `Promise`\<[`NetworkRule`](../types.md#networkrule)\>
...
> **listAll**(`options?`): `AsyncGenerator`\<[`NetworkRule`](../types.md#networkrule)\>
...
`AsyncGenerator`\<[`NetworkRule`](../types.md#networkrule)\>
...
> **update**(`key`, `params`, `options?`): `Promise`\<[`NetworkRule`](../types.md#networkrule)\>
...
| `params` | [`NetworkRuleUpdateParams`](../types.md#networkruleupdateparams) | The fields to update |
...
> **create**(`params`, `options?`): `Promise`\<[`NetworkRule`](../types.md#networkrule)\>
...
| Parameter | Type | Description |
| ------ | ------ | ------ |
| `params` | [`NetworkRuleCreateParams`](../types.md#networkrulecreateparams) | The resource creation parameters |
| `options?` | [`MutationOptions`](../types.md#mutationoptions) | Mutation options (e.g., `readBack: false` to skip re-fetch) |
...
> **listByNetwork**(`vnetKey`, `options?`): `Promise`\<[`NetworkRule`](../types.md#networkrule)[]\>

Defined in: [services/network-rule/service.ts:56](https://github.com/verge-io/tsvergeos/blob/062717088bda09370ccf0807d21fafeb6b471b69/packages/sdk/src/services/network-rule/service.ts#L56)
...
Array of rules for the specified network

##### enable()

> **enable**(`key`): `Promise`\<`void`\>

Defined in: [services/network-rule/service.ts:74](https://github.com/verge-io/tsvergeos/blob/062717088bda09370ccf0807d21fafeb6b471b69/packages/sdk/src/services/network-rule/service.ts#L74)
...
| Parameter | Type | Description |
| ------ | ------ | ------ |
| `key` | [`FlexKey`](../types.md#flexkey) | The rule ID to enable |
...
Defined in: [services/network-rule/service.ts:85](https://github.com/verge-io/tsvergeos/blob/062717088bda09370ccf0807d21fafeb6b471b69/packages/sdk/src/services/network-rule/service.ts#L85)
...
| Parameter | Type | Description |
| ------ | ------ | ------ |
| `key` | [`FlexKey`](../types.md#flexkey) | The rule ID to disable |
...
> **tag**(`key`, `tag`): `Promise`\<`void`\>

Defined in: [services/network-rule/service.ts:97](https://github.com/verge-io/tsvergeos/blob/062717088bda09370ccf0807d21fafeb6b471b69/packages/sdk/src/services/network-rule/service.ts#L97)
...
| Parameter | Type | Description |
| ------ | ------ | ------ |
| `key` | [`FlexKey`](../types.md#flexkey) | The rule ID |
| `tag` | `string` | The tag member reference (e.g., `"tags/123"`) |
...
> **untag**(`key`, `tag`): `Promise`\<`void`\>

Defined in: [services/network-rule/service.ts:109](https://github.com/verge-io/tsvergeos/blob/062717088bda09370ccf0807d21fafeb6b471b69/packages/sdk/src/services/network-rule/service.ts#L109)
...
Re-exports [NetworkRule](../types.md#networkrule)

***

### NetworkRuleCreateParams

Re-exports [NetworkRuleCreateParams](../types.md#networkrulecreateparams)

***

### NetworkRuleUpdateParams

Re-exports [NetworkRuleUpdateParams](../types.md#networkruleupdateparams)

***

### RuleAction

Re-exports [RuleAction](../types.md#ruleaction)

***

### RuleDirection

Re-exports [RuleDirection](../types.md#ruledirection)

***

### RuleInterface

Re-exports [RuleInterface](../types.md#ruleinterface)

***

### RulePin

Re-exports [RulePin](../types.md#rulepin)

***

### RuleProtocol

Re-exports [RuleProtocol](../types.md#ruleprotocol)
