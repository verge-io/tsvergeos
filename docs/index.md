...
Defined in: [client.ts:30](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/client.ts#L30)
...
Defined in: [client.ts:56](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/client.ts#L56)
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="property-alarmtypes"></a> `alarmTypes` | `readonly` | [`AlarmTypeService`](services/alarm-type.md#alarmtypeservice) | Service for querying alarm type definitions. | [services/alarm-type/index.ts:22](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/services/alarm-type/index.ts#L22) |
| <a id="property-alarms"></a> `alarms` | `readonly` | [`AlarmService`](services/alarm.md#alarmservice) | Service for managing alarms. | [services/alarm/index.ts:22](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/services/alarm/index.ts#L22) |
| <a id="property-apikeys"></a> `apiKeys` | `readonly` | [`APIKeyService`](services/api-key.md#apikeyservice) | Service for managing user API keys. | [services/api-key/index.ts:22](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/services/api-key/index.ts#L22) |
...
| <a id="property-catalogs"></a> `catalogs` | `readonly` | [`CatalogService`](services/catalog.md#catalogservice) | Service for managing catalogs. | [services/catalog/index.ts:22](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/services/catalog/index.ts#L22) |
...
| <a id="property-clusters"></a> `clusters` | `readonly` | [`ClusterService`](services/cluster.md#clusterservice) | Service for managing VergeOS clusters. | [services/cluster/index.ts:22](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/services/cluster/index.ts#L22) |
| <a id="property-files"></a> `files` | `readonly` | [`FileService`](services/file.md#fileservice) | Service for managing files (upload, download, metadata CRUD). | [services/file/index.ts:22](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/services/file/index.ts#L22) |
| <a id="property-groups"></a> `groups` | `readonly` | [`GroupService`](services/group.md#groupservice) | Service for managing groups. | [services/group/index.ts:22](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/services/group/index.ts#L22) |
...
| <a id="property-ipsec"></a> `ipsec` | `readonly` | [`IPSecService`](services/ipsec.md#ipsecservice) | Service for managing IPSec VPN configurations on virtual networks. | [services/ipsec/index.ts:22](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/services/ipsec/index.ts#L22) |
| <a id="property-logs"></a> `logs` | `readonly` | [`LogService`](services/log.md#logservice) | Service for querying VergeOS system logs. | [services/log/index.ts:22](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/services/log/index.ts#L22) |
...
| <a id="property-members"></a> `members` | `readonly` | [`MemberService`](services/member.md#memberservice) | Service for managing group memberships. | [services/member/index.ts:22](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/services/member/index.ts#L22) |
...
| <a id="property-networks"></a> `networks` | `readonly` | [`NetworkService`](services/network.md#networkservice) | Service for managing virtual networks. | [services/network/index.ts:22](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/services/network/index.ts#L22) |
| <a id="property-nodes"></a> `nodes` | `readonly` | [`NodeService`](services/node.md#nodeservice) | Service for managing VergeOS nodes. | [services/node/index.ts:22](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/services/node/index.ts#L22) |
...
| <a id="property-sites"></a> `sites` | `readonly` | [`SiteService`](services/site.md#siteservice) | Service for managing remote sites. | [services/site/index.ts:22](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/services/site/index.ts#L22) |
| <a id="property-snapshotprofileperiods"></a> `snapshotProfilePeriods` | `readonly` | [`SnapshotProfilePeriodService`](services/snapshot-profile-period.md#snapshotprofileperiodservice) | Service for managing snapshot profile periods. | [services/snapshot-profile-period/index.ts:23](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/services/snapshot-profile-period/index.ts#L23) |
...
| <a id="property-tags"></a> `tags` | `readonly` | [`TagService`](services/tag.md#tagservice) | Service for managing tags. | [services/tag/index.ts:22](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/services/tag/index.ts#L22) |
| <a id="property-tasks"></a> `tasks` | `readonly` | [`TaskService`](services/task.md#taskservice) | Service for managing tasks. | [services/task/index.ts:22](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/services/task/index.ts#L22) |
...
| <a id="property-tenants"></a> `tenants` | `readonly` | [`TenantService`](services/tenant.md#tenantservice) | Service for managing tenants. | [services/tenant/index.ts:22](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/services/tenant/index.ts#L22) |
...
| <a id="property-users"></a> `users` | `readonly` | [`UserService`](services/user.md#userservice) | Service for managing users. | [services/user/index.ts:22](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/services/user/index.ts#L22) |
...
| <a id="property-vmrecipes"></a> `vmRecipes` | `readonly` | [`VMRecipeService`](services/vm-recipe.md#vmrecipeservice) | Service for managing VM recipes. | [services/vm-recipe/index.ts:22](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/services/vm-recipe/index.ts#L22) |
| <a id="property-vms"></a> `vms` | `readonly` | [`VMService`](services/vm.md#vmservice) | Service for managing virtual machines. | [services/vm/index.ts:22](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/services/vm/index.ts#L22) |
...
| <a id="property-volumes"></a> `volumes` | `readonly` | [`VolumeService`](services/volume.md#volumeservice) | Service for managing volumes. | [services/volume/index.ts:22](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/services/volume/index.ts#L22) |
...
| <a id="property-webhooks"></a> `webhooks` | `readonly` | [`WebhookService`](services/webhook.md#webhookservice) | Service for querying webhook delivery logs. | [services/webhook/index.ts:22](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/services/webhook/index.ts#L22) |
...
Defined in: [client.ts:105](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/client.ts#L105)
...
Defined in: [client.ts:113](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/client.ts#L113)
...
Defined in: [client.ts:136](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/client.ts#L136)
...
Defined in: [client.ts:150](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/client.ts#L150)
...
Defined in: [client.ts:170](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/client.ts#L170)
...
Defined in: [client.ts:185](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/client.ts#L185)
...
Defined in: [cross-site.ts:97](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/cross-site.ts#L97)
...
Defined in: [errors.ts:6](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/errors.ts#L6)
...
Defined in: [errors.ts:7](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/errors.ts#L7)
...
Defined in: [errors.ts:18](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/errors.ts#L18)
...
Defined in: [errors.ts:25](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/errors.ts#L25)
...
| Property | Modifier | Type | Description | Defined in |
| ------ | ------ | ------ | ------ | ------ |
| <a id="property-statuscode"></a> `statusCode` | `readonly` | `number` | HTTP status code from the API response. | [errors.ts:20](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/errors.ts#L20) |
| <a id="property-endpoint"></a> `endpoint` | `readonly` | `string` | API endpoint that returned the error. | [errors.ts:23](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/errors.ts#L23) |

***

### ConflictError

Defined in: [errors.ts:38](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/errors.ts#L38)
...
Defined in: [errors.ts:39](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/errors.ts#L39)
...
| ------ | ------ | ------ | ------ | ------ | ------ |
| <a id="property-statuscode-1"></a> `statusCode` | `readonly` | `number` | HTTP status code from the API response. | [`ApiError`](#apierror).[`statusCode`](#property-statuscode) | [errors.ts:20](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/errors.ts#L20) |
| <a id="property-endpoint-1"></a> `endpoint` | `readonly` | `string` | API endpoint that returned the error. | [`ApiError`](#apierror).[`endpoint`](#property-endpoint) | [errors.ts:23](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/errors.ts#L23) |

***

### AuthError

Defined in: [errors.ts:49](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/errors.ts#L49)
...
Defined in: [errors.ts:50](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/errors.ts#L50)
...
Defined in: [errors.ts:60](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/errors.ts#L60)
...
Defined in: [errors.ts:67](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/errors.ts#L67)
...
| Property | Modifier | Type | Description | Defined in |
| ------ | ------ | ------ | ------ | ------ |
| <a id="property-resource-1"></a> `resource` | `readonly` | `string` | The type of resource that was not found (e.g., "vms", "networks"). | [errors.ts:62](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/errors.ts#L62) |
| <a id="property-id"></a> `id` | `readonly` | `string` \| `number` | The ID of the resource that was not found. | [errors.ts:65](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/errors.ts#L65) |

***

### ValidationError

Defined in: [errors.ts:79](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/errors.ts#L79)
...
Defined in: [errors.ts:83](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/errors.ts#L83)
...
| Property | Modifier | Type | Description | Defined in |
| ------ | ------ | ------ | ------ | ------ |
| <a id="property-field"></a> `field?` | `readonly` | `string` | The field that failed validation, if applicable. | [errors.ts:81](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/errors.ts#L81) |

***

### TaskError

Defined in: [errors.ts:94](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/errors.ts#L94)
...
Defined in: [errors.ts:98](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/errors.ts#L98)
...
| Property | Modifier | Type | Description | Defined in |
| ------ | ------ | ------ | ------ | ------ |
| <a id="property-taskid"></a> `taskId` | `readonly` | `string` \| `number` | The ID of the task that failed. | [errors.ts:96](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/errors.ts#L96) |

***

### TaskTimeoutError

Defined in: [errors.ts:110](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/errors.ts#L110)
...
Defined in: [errors.ts:114](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/errors.ts#L114)
...
| Property | Modifier | Type | Description | Inherited from | Defined in |
| ------ | ------ | ------ | ------ | ------ | ------ |
| <a id="property-taskid-1"></a> `taskId` | `readonly` | `string` \| `number` | The ID of the task that failed. | [`TaskError`](#taskerror).[`taskId`](#property-taskid) | [errors.ts:96](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/errors.ts#L96) |
| <a id="property-timeout"></a> `timeout` | `readonly` | `number` | The timeout duration in milliseconds that was exceeded. | - | [errors.ts:112](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/errors.ts#L112) |

***

### UnsupportedVersionError

Defined in: [errors.ts:125](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/errors.ts#L125)
...
Defined in: [errors.ts:132](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/errors.ts#L132)
...
| Property | Modifier | Type | Description | Defined in |
| ------ | ------ | ------ | ------ | ------ |
| <a id="property-serverversion"></a> `serverVersion` | `readonly` | `string` | The server version that was detected. | [errors.ts:127](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/errors.ts#L127) |
| <a id="property-required"></a> `required` | `readonly` | `string` | The minimum required version. | [errors.ts:130](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/errors.ts#L130) |

***

### SiteError

Defined in: [errors.ts:145](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/errors.ts#L145)
...
Defined in: [errors.ts:149](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/errors.ts#L149)
...
| Property | Modifier | Type | Description | Defined in |
| ------ | ------ | ------ | ------ | ------ |
| <a id="property-site-1"></a> `site` | `readonly` | `string` | The name of the site where the error occurred. | [errors.ts:147](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/errors.ts#L147) |

***

### Filter

Defined in: [filter.ts:81](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/filter.ts#L81)
...
Defined in: [filter.ts:107](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/filter.ts#L107)
...
Defined in: [filter.ts:113](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/filter.ts#L113)
...
Defined in: [filter.ts:119](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/filter.ts#L119)
...
Defined in: [filter.ts:125](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/filter.ts#L125)
...
Defined in: [filter.ts:131](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/filter.ts#L131)
...
Defined in: [filter.ts:137](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/filter.ts#L137)
...
Defined in: [filter.ts:149](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/filter.ts#L149)
...
Defined in: [filter.ts:162](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/filter.ts#L162)
...
Defined in: [filter.ts:179](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/filter.ts#L179)
...
Defined in: [filter.ts:189](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/filter.ts#L189)
...
Defined in: [http.ts:84](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/http.ts#L84)
...
Defined in: [http.ts:114](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/http.ts#L114)
...
Defined in: [http.ts:97](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/http.ts#L97)
...
Defined in: [http.ts:141](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/http.ts#L141)
...
Defined in: [http.ts:152](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/http.ts#L152)
...
Defined in: [http.ts:163](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/http.ts#L163)
...
Defined in: [http.ts:173](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/http.ts#L173)
...
Defined in: [http.ts:185](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/http.ts#L185)
...
Defined in: [http.ts:200](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/http.ts#L200)
...
Defined in: [http.ts:238](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/http.ts#L238)
...
Defined in: [services/base.ts:118](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/services/base.ts#L118)
...
Defined in: [services/base.ts:145](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/services/base.ts#L145)
...
| Property | Modifier | Type | Description | Defined in |
| ------ | ------ | ------ | ------ | ------ |
| <a id="property-resource-2"></a> `resource` | `readonly` | `string` | API resource path (e.g., `'/vms'`). | [services/base.ts:123](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/services/base.ts#L123) |
| <a id="property-displayname"></a> `displayName` | `readonly` | `string` | Human-readable resource name for error messages (e.g., `'VM'`). | [services/base.ts:126](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/services/base.ts#L126) |
| <a id="property-defaultfields"></a> `defaultFields?` | `protected` | `string`[] | Per-service default fields for API requests. When set by a subclass, these fields are used instead of `'most'` for `list()` and `get()` calls where the caller does not provide explicit `fields`. This enables cross-resource joins (e.g., `machine#status#status`) so that derived fields like power state are reliably populated. User-provided `fields` always take precedence. | [services/base.ts:138](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/services/base.ts#L138) |
...
Defined in: [services/base.ts:254](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/services/base.ts#L254)
...
Defined in: [services/base.ts:264](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/services/base.ts#L264)
...
| Property | Modifier | Type | Description | Inherited from | Defined in |
| ------ | ------ | ------ | ------ | ------ | ------ |
| <a id="property-resource-3"></a> `resource` | `readonly` | `string` | API resource path (e.g., `'/vms'`). | [`ReadOnlyService`](#readonlyservice).[`resource`](#property-resource-2) | [services/base.ts:123](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/services/base.ts#L123) |
| <a id="property-displayname-1"></a> `displayName` | `readonly` | `string` | Human-readable resource name for error messages (e.g., `'VM'`). | [`ReadOnlyService`](#readonlyservice).[`displayName`](#property-displayname) | [services/base.ts:126](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/services/base.ts#L126) |
| <a id="property-defaultfields-1"></a> `defaultFields?` | `protected` | `string`[] | Per-service default fields for API requests. When set by a subclass, these fields are used instead of `'most'` for `list()` and `get()` calls where the caller does not provide explicit `fields`. This enables cross-resource joins (e.g., `machine#status#status`) so that derived fields like power state are reliably populated. User-provided `fields` always take precedence. | [`ReadOnlyService`](#readonlyservice).[`defaultFields`](#property-defaultfields) | [services/base.ts:138](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/services/base.ts#L138) |
| <a id="property-actionconfig"></a> `actionConfig` | `readonly` | [`ActionConfig`](#actionconfig) | Derived or overridden action endpoint configuration. | - | [services/base.ts:256](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/services/base.ts#L256) |
...
Defined in: [services/base.ts:384](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/services/base.ts#L384)
...
| Property | Modifier | Type | Description | Inherited from | Defined in |
| ------ | ------ | ------ | ------ | ------ | ------ |
| <a id="property-resource-4"></a> `resource` | `readonly` | `string` | API resource path (e.g., `'/vms'`). | [`WritableService`](#writableservice).[`resource`](#property-resource-3) | [services/base.ts:123](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/services/base.ts#L123) |
| <a id="property-displayname-2"></a> `displayName` | `readonly` | `string` | Human-readable resource name for error messages (e.g., `'VM'`). | [`WritableService`](#writableservice).[`displayName`](#property-displayname-1) | [services/base.ts:126](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/services/base.ts#L126) |
| <a id="property-defaultfields-2"></a> `defaultFields?` | `protected` | `string`[] | Per-service default fields for API requests. When set by a subclass, these fields are used instead of `'most'` for `list()` and `get()` calls where the caller does not provide explicit `fields`. This enables cross-resource joins (e.g., `machine#status#status`) so that derived fields like power state are reliably populated. User-provided `fields` always take precedence. | [`WritableService`](#writableservice).[`defaultFields`](#property-defaultfields-1) | [services/base.ts:138](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/services/base.ts#L138) |
| <a id="property-actionconfig-1"></a> `actionConfig` | `readonly` | [`ActionConfig`](#actionconfig) | Derived or overridden action endpoint configuration. | [`WritableService`](#writableservice).[`actionConfig`](#property-actionconfig) | [services/base.ts:256](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/services/base.ts#L256) |
...
Defined in: [site-manager.ts:67](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/site-manager.ts#L67)
...
Defined in: [site-manager.ts:83](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/site-manager.ts#L83)
...
Defined in: [site-manager.ts:90](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/site-manager.ts#L90)
...
Defined in: [site-manager.ts:212](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/site-manager.ts#L212)
...
Defined in: [site-manager.ts:152](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/site-manager.ts#L152)
...
Defined in: [site-manager.ts:165](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/site-manager.ts#L165)
...
Defined in: [site-manager.ts:177](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/site-manager.ts#L177)
...
Defined in: [site-manager.ts:185](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/site-manager.ts#L185)
...
Defined in: [site-manager.ts:195](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/site-manager.ts#L195)
...
Defined in: [site-manager.ts:232](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/site-manager.ts#L232)
...
Defined in: [cross-site.ts:15](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/cross-site.ts#L15)
...
| ------ | ------ | ------ | ------ |
| <a id="property-site"></a> `site` | `string` | Site name as registered via `addSite()`. | [cross-site.ts:17](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/cross-site.ts#L17) |
| <a id="property-resource"></a> `resource` | `T` | The resource from that site. | [cross-site.ts:19](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/cross-site.ts#L19) |

***

### CrossSiteResult

Defined in: [cross-site.ts:28](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/cross-site.ts#L28)
...
| Property | Type | Description | Defined in |
| ------ | ------ | ------ | ------ |
| <a id="property-data"></a> `data` | [`SiteResource`](#siteresource)\<`T`\>[] | Resources from all successful sites, flattened and tagged with site name. | [cross-site.ts:30](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/cross-site.ts#L30) |
| <a id="property-errors"></a> `errors` | [`SiteError`](#siteerror)[] | One [SiteError](#siteerror) per site that failed. | [cross-site.ts:32](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/cross-site.ts#L32) |

***

### ActionConfig

Defined in: [services/base.ts:11](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/services/base.ts#L11)
...
| Property | Type | Description | Defined in |
| ------ | ------ | ------ | ------ |
| <a id="property-endpoint-2"></a> `endpoint` | `string` | The action endpoint path (e.g., `'vm_actions'`). | [services/base.ts:13](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/services/base.ts#L13) |
| <a id="property-key"></a> `key` | `string` | The body key that identifies the target resource (e.g., `'vm'`). | [services/base.ts:15](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/services/base.ts#L15) |

***

### SiteConfig

Defined in: [site-manager.ts:11](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/site-manager.ts#L11)
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="property-name"></a> `name` | `string` | Unique name for this site (e.g., "dc-east", "edge-01"). | - | [site-manager.ts:13](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/site-manager.ts#L13) |
| <a id="property-tags-1"></a> `tags?` | `string`[] | Optional tags for grouping sites in fan-out queries. | - | [site-manager.ts:16](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/site-manager.ts#L16) |
| <a id="property-host"></a> `host` | `string` | VergeOS server hostname or URL (e.g., "192.168.1.100" or "https://my-verge.example.com"). | [`ClientConfig`](types.md#clientconfig).[`host`](types.md#property-host-7) | [types.ts:30](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/types.ts#L30) |
| <a id="property-username"></a> `username?` | `string` | Username for authentication (used with password-based auth). | [`ClientConfig`](types.md#clientconfig).[`username`](types.md#property-username-2) | [types.ts:33](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/types.ts#L33) |
| <a id="property-password"></a> `password?` | `string` | Password for authentication (used with password-based auth). | [`ClientConfig`](types.md#clientconfig).[`password`](types.md#property-password-20) | [types.ts:36](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/types.ts#L36) |
| <a id="property-apikey"></a> `apiKey?` | `string` | API key for token-based authentication. | [`ClientConfig`](types.md#clientconfig).[`apiKey`](types.md#property-apikey-1) | [types.ts:39](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/types.ts#L39) |
| <a id="property-verifyssl"></a> `verifySsl?` | `boolean` | Whether to verify SSL certificates. Defaults to `true`. **Note:** The SDK uses the platform's native `fetch` implementation, which does not expose certificate validation controls. This option is respected when you supply a custom `fetch` that honours it (e.g., `undici` with a custom `Agent`, or Node.js `https.Agent` with `rejectUnauthorized`). In browsers, certificate validation is always enforced by the runtime. | [`ClientConfig`](types.md#clientconfig).[`verifySsl`](types.md#property-verifyssl) | [types.ts:50](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/types.ts#L50) |
| <a id="property-timeout-1"></a> `timeout?` | `number` | Request timeout in milliseconds. Defaults to `DEFAULT_TIMEOUT`. | [`ClientConfig`](types.md#clientconfig).[`timeout`](types.md#property-timeout-5) | [types.ts:53](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/types.ts#L53) |
| <a id="property-retries"></a> `retries?` | `number` | Number of retry attempts for failed requests. Defaults to `DEFAULT_RETRIES`. | [`ClientConfig`](types.md#clientconfig).[`retries`](types.md#property-retries-3) | [types.ts:56](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/types.ts#L56) |
| <a id="property-retrybackoff"></a> `retryBackoff?` | `number` | Backoff interval between retries in milliseconds. Defaults to `DEFAULT_RETRY_BACKOFF`. | [`ClientConfig`](types.md#clientconfig).[`retryBackoff`](types.md#property-retrybackoff) | [types.ts:59](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/types.ts#L59) |
| <a id="property-fetch"></a> `fetch?` | (`input`, `init?`) => `Promise`\<`Response`\> | Custom fetch implementation for testing or platform-specific overrides. | [`ClientConfig`](types.md#clientconfig).[`fetch`](types.md#property-fetch) | [types.ts:62](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/types.ts#L62) |
| <a id="property-signal"></a> `signal?` | `AbortSignal` | AbortSignal for cancelling requests. | [`ClientConfig`](types.md#clientconfig).[`signal`](types.md#property-signal) | [types.ts:65](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/types.ts#L65) |

***

### SiteManagerOptions

Defined in: [site-manager.ts:22](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/site-manager.ts#L22)
...
| Property | Type | Description | Defined in |
| ------ | ------ | ------ | ------ |
| <a id="property-timeout-2"></a> `timeout?` | `number` | Default timeout in milliseconds for fan-out operations. | [site-manager.ts:24](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/site-manager.ts#L24) |

***

### SiteStatus

Defined in: [site-manager.ts:31](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/site-manager.ts#L31)
...
| Property | Type | Description | Defined in |
| ------ | ------ | ------ | ------ |
| <a id="property-connected"></a> `connected` | `boolean` | Whether the site is believed to be reachable. | [site-manager.ts:33](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/site-manager.ts#L33) |
| <a id="property-version"></a> `version?` | `string` | Server version string from the last successful connection. | [site-manager.ts:36](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/site-manager.ts#L36) |
| <a id="property-systemid"></a> `systemId?` | `string` | System ID from the server, if available. | [site-manager.ts:39](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/site-manager.ts#L39) |
| <a id="property-lasterror"></a> `lastError?` | `Error` | Last error encountered when communicating with this site. | [site-manager.ts:42](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/site-manager.ts#L42) |
...
Defined in: [cross-site.ts:53](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/cross-site.ts#L53)
...
Defined in: [filter.ts:32](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/filter.ts#L32)
...
Defined in: [filter.ts:35](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/filter.ts#L35)
...
Defined in: [filter.ts:40](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/filter.ts#L40)
...
Defined in: [constants.ts:2](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/constants.ts#L2)
...
Defined in: [constants.ts:5](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/constants.ts#L5)
...
Defined in: [constants.ts:8](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/constants.ts#L8)
...
Defined in: [constants.ts:11](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/constants.ts#L11)
...
Defined in: [constants.ts:14](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/constants.ts#L14)
...
Defined in: [constants.ts:17](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/constants.ts#L17)
...
Defined in: [constants.ts:20](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/constants.ts#L20)
...
Defined in: [constants.ts:23](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/constants.ts#L23)
...
Defined in: [constants.ts:26](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/constants.ts#L26)
...
Defined in: [constants.ts:29](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/constants.ts#L29)
...
Defined in: [constants.ts:32](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/constants.ts#L32)
...
Defined in: [constants.ts:35](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/constants.ts#L35)
...
Defined in: [constants.ts:38](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/constants.ts#L38)
...
Defined in: [errors.ts:167](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/errors.ts#L167)
...
Defined in: [errors.ts:173](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/errors.ts#L173)
...
Defined in: [errors.ts:179](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/errors.ts#L179)
...
Defined in: [errors.ts:187](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/errors.ts#L187)
...
Defined in: [errors.ts:194](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/errors.ts#L194)
...
Defined in: [errors.ts:201](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/errors.ts#L201)
...
Defined in: [errors.ts:208](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/errors.ts#L208)
...
Defined in: [errors.ts:213](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/errors.ts#L213)
...
Defined in: [errors.ts:219](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/errors.ts#L219)
...
Defined in: [errors.ts:225](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/errors.ts#L225)
...
Defined in: [filter.ts:231](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/filter.ts#L231)
...
Defined in: [filter.ts:275](https://github.com/verge-io/tsvergeos/blob/1053cf975fe1bacd1ca9d53743740ae63a601a08/packages/sdk/src/filter.ts#L275)
