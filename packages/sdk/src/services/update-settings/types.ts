...
export interface UpdateSettings extends Resource {
	...
	/** Currently installed version string. Read-only. */
	installed?: string;
	...
	/** Applying updates status message. Read-only. */
	applying_updates_status?: string;

	/** Applying updates progress percentage. Read-only. */
	applying_updates_progress?: number;
}
