...
> {
	 ...
	 */
	async listBySite(siteKey: FlexKey, options?: ListOptions): Promise<SiteSyncOutgoing[]> {
	 ...
	 */
	async throttleSync(key: FlexKey, params?: Record<string, unknown>): Promise<void> {
	 ...
	 */
	async addToQueue(key: FlexKey, params?: Record<string, unknown>): Promise<void> {
