...
export class SiteManager {
  ...
  /** Cached all-sites proxy, invalidated on addSite/removeSite. */
  private _allProxy: (CrossSiteReadProxy & CrossSiteServices) | undefined;
  ...
  get all(): CrossSiteReadProxy & CrossSiteServices {
    if (!this._allProxy) {
      this._allProxy = new CrossSiteReadProxy(
   ...
   * Used internally by CrossSiteReadProxy.
   *
   * @internal
  ...
  /**
   * Update the status for a site. Used by CrossSiteReadProxy
