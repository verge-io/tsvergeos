...
export interface ClientConfig {
   ...
   *
   * **Note:** The SDK uses the platform's native `fetch` implementation, which
   * does not expose certificate validation controls. This option is respected
   * when you supply a custom `fetch` that honours it (e.g., `undici` with a
   * custom `Agent`, or Node.js `https.Agent` with `rejectUnauthorized`).
   * In browsers, certificate validation is always enforced by the runtime.
   */
  verifySsl?: boolean;
...
} from "./services/cloud-init/types.js";
export type {
  CloudSnapshot,
...
export type { MachineStatsHistoryShort } from "./services/machine-stats-history-short/types.js";
export type { MachineStatsHistoryLong } from "./services/machine-stats-history-long/types.js";
export type {
  MachineState,
  MachineStatus,
  MachineStatusValue,
...
} from "./services/resource-group/types.js";
export type {
  Setting,
  SettingUpdateParams,
...
} from "./services/snapshot-profile/types.js";
export type {
  PeriodDayOfWeek,
  PeriodFrequency,
  PeriodMaxTier,
...
} from "./services/snapshot-profile-period/types.js";
...
} from "./services/tag-member/types.js";
export type {
  Task,
  TaskCreateParams,
  TaskStatus,
...
export type { Webhook, WebhookStatus } from "./services/webhook/types.js";
export type {
  WebhookURL,
...
} from "./services/webhook-url/types.js";
export type {
  WireGuard,
...
export type { VnetMonitorStatsHistoryShort } from "./services/vnet-monitor-stats-history-short/types.js";
export type { VnetMonitorStatsHistoryLong } from "./services/vnet-monitor-stats-history-long/types.js";
