...
export default defineConfig({
  entry: {
    ...
    "services/machine-nic-stats/index":
    ...
    "services/storage-tier-stats/index":
      "src/services/storage-tier-stats/index.ts",
    "services/cluster-tier/index": "src/services/cluster-tier/index.ts",
    "services/cluster-tier-stats/index":
      "src/services/cluster-tier-stats/index.ts",
    "services/cluster-tier-status/index":
      "src/services/cluster-tier-status/index.ts",
    "services/wireguard-peer-status/index":
      "src/services/wireguard-peer-status/index.ts",
    ...
    "services/vm-recipe-instance/index":
      "src/services/vm-recipe-instance/index.ts",
    "services/tenant-recipe/index": "src/services/tenant-recipe/index.ts",
    "services/tenant-recipe-instance/index":
      "src/services/tenant-recipe-instance/index.ts",
    "services/catalog/index": "src/services/catalog/index.ts",
    "services/catalog-repository/index":
      "src/services/catalog-repository/index.ts",
    ...
    "services/snapshot-profile-period/index":
      "src/services/snapshot-profile-period/index.ts",
    "services/cloud-snapshot/index": "src/services/cloud-snapshot/index.ts",
    "services/cloud-snapshot-vm/index":
      "src/services/cloud-snapshot-vm/index.ts",
    "services/cloud-snapshot-tenant/index":
      "src/services/cloud-snapshot-tenant/index.ts",
    "services/site/index": "src/services/site/index.ts",
    "services/site-sync-incoming/index":
    ...
    "services/webhook-url/index": "src/services/webhook-url/index.ts",
    "services/webhook/index": "src/services/webhook/index.ts",
    "services/cloud-init/index": "src/services/cloud-init/index.ts",
    "services/resource-group/index": "src/services/resource-group/index.ts",
    "services/update-settings/index": "src/services/update-settings/index.ts",
    "services/update-source/index": "src/services/update-source/index.ts",
    "services/update-branch/index": "src/services/update-branch/index.ts",
    "services/update-source-package/index":
      "src/services/update-source-package/index.ts",
  },
  format: ["esm", "cjs"],
  dts: true,
  sourcemap: true,
